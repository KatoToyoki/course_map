    ...
    <div>
      <div className="phone_menu">
        <Dropdown>
          <Dropdown.Toggle id="dropdown-basic" className="blue">
            <h3 className="inside">選單</h3>
          </Dropdown.Toggle>

          <Dropdown.Menu>
            <Dropdown.Item href="/introduce#course">微學程簡介</Dropdown.Item>
            <Dropdown.Item href="/introduce#taking_course">
              修讀微學程
            </Dropdown.Item>
            <Dropdown.Item href="/introduce#future_jobs">
              就業前景
            </Dropdown.Item>
            <Dropdown.Item href="/introduce#learning_material">
              學習資源
            </Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
      ...
      <div>
        <a href="/introduce#course" className="no_decoration white_word">
          <div className="com_button1">微學程簡介</div>
        </a>

        <a href="/introduce#taking_course" className="no_decoration white_word">
          <div className="com_button2">修讀微學程</div>
        </a>

        <a href="/introduce#future_jobs" className="no_decoration white_word">
          <div className="com_button3">就業前景</div>
        </a>

        <a
          href="/introduce#learning_material"
          className="no_decoration white_word"
        >
          <div className="com_button4">學習資源</div>
        </a>
      </div>
      ...
      <div className="c_container">
        <div className="content">
          ...
          <div>
            ...
            <p className="inside">✻流程若有更動，依本校教務處公告為主。</p>
            ...
            <p className="inside">
              <b>北科學生修讀：</b>
              <br />
              欲修讀微學程之北科學生，依本校每學期選課開放時間(含加退選)內完成選課，
              修讀期間請留意完成
              <a href="hhttps://oaa.ntut.edu.tw/p/423-1008-3207.php?Lang=zh-tw">
                微學程登記
              </a>
              ，開放登記時間依教務處公告。
              <br />
              <b>跨校學生修讀：</b>
              <br />
              北聯大系統之學生，同學應先填具本校「校際選課申請表-外校生至本校選課用」，
              ...
              <Col sm={12} md={4} className="map_inside">
                <div className="intro_1 inside">
                  <div className="white map_inside">
                    ...
                    <div className="center">選修至少2門課</div>
                  </div>
                  <br />
                  <ul className="white_word">
                    {base.map((data, index) =>
                      index === 0 ? (
                        <li key={index}>程式設計相關課程</li>
                      ) : (
                        <li key={index}>{data.course_name}</li>
                      )
                    )}
                  </ul>
                </div>
              ...
              <Col sm={12} md={4} className="map_inside">
                <div className="intro_2 inside">
                  <div className="white map_inside">
                    ...
                    <div className="center">選修至少1門課</div>
                  </div>
                  <br />
                  <ul className="white_word">
                    {medium.map((data, index) => {
                      return <li>{data.course_name}</li>;
                    })}
                  </ul>
                </div>
              </Col>
            ...
            <ol>
              <li>
                修習各類學程之學生每學期所修學分上下限仍依本校學則相關規定辦理。
              </li>
              <li>
                修習各類學程其科目成績需併入學期修習總學分及學期成績計算。
              </li>
              <li>
                修畢各類學程科目之學分，屬原系專業課程，計入專業學分；非屬原系課程，得計入跨系所選修學分，惟課程名稱及內容相同之科目，不得重複修習。
              </li>
              <li>
                詳細規範請參閱修讀細則、課程規劃書、學程實施辦法，依本校教務處公告為主。
              </li>
            </ol>
            <h5 className="orange_word">
              <b>申請證書</b>
            ...
            <ul>
              <li>
                <a href="/download">點我前往相關網頁連結一覽</a>
              </li>
          ...
          <div>
            ...
            <ul>
              <li>
                <b>共授專家分享</b>
                ：每門課程會邀請產業講師或專家學者進行分享，提供豐富的產業知識。
              </li>

              <li>
                <b>參訪講座活動</b>
                ：不定期舉辦企業參訪、專題講座等豐富活動，增添同學們的學習視野。
              </li>

              <li>
                <b>交流學習聚會</b>
                ：不定期舉辦交流學習聚會，讓同學間分享學習進度或教育議題等。
              </li>

              <li>
                <b>多元輔導機制</b>
                ：每門課程設置兩名助教，於每週固定時段提供課外輔導，提供給有需要的同學。
              </li>

              <li>
                <b>網路交流平臺</b>
                ：同學可以透過臉書/line社群發問，得到需要的協助與回應。
              </li>

              <li>
                <b>召開學生研習</b>
                ：能力不足的同學可以透過同儕之間的相互指導，跟上課程內容。
              </li>

              <li>
                <b>提供課程地圖</b>
                ：讓同學得到更明確的修課指引，安排修讀時間設立目標促進修習。
              </li>
            </ul>
          </div>
        </div>
