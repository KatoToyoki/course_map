            ...
            <Navbar expand="lg" variant='dark' className='nav_container'>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        <Nav.Link href="/introduce" className='white_word'><b>認識微學程</b></Nav.Link>
                        <Nav.Link href="/map" className='white_word'><b>知識地圖</b></Nav.Link>
                        <Nav.Link href="/qa" className='white_word'><b>修讀QA</b></Nav.Link>
                        <Nav.Link href="/about" className='white_word'><b>關於本計畫</b></Nav.Link>
                        <Nav.Link href="/result" className='white_word'><b>計畫成果</b></Nav.Link>
                        <Nav.Link href="/download" className='white_word'><b>檔案下載</b></Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
            <Outlet />
